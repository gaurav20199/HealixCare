...
public class LocalStackInitializer extends Stack {
  private final Vpc vpc;
  private final Cluster ecsCluster;

  public LocalStackInitializer(final App scope, final String id, final StackProps props){
  ...
  private FargateService createFargateService(String id,
    ...
    if(db != null){
      ...
      envVars.put("SPRING_FLYWAY_LOCATIONS","classpath:db/migration/common,classpath:db/migration/dev");
  ...
  public static void main(final String[] args) {
    ...
    new LocalStackInitializer(app, "localstack", props);
    app.synth();
